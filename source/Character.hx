...
/*typedef CharacterData =
{
	...
	var iconName:String;                          IN PROGRESS
	var animationsName:Array<Dynamic>;
	var x:Int;    
	var y:Int;
}
*/
class Character extends FlxSprite
{
	...
	var char:CharacterData = {
		charName: "bf",
		spriteSheet: "assets/images/BF",
		iconColor: "0xFF31B0D1",
		iconName: "bf",
		animationsName: [['UP', 'LEFT', 'RIGHT', 'DOWN', 'IDLE']],
		x: 0,
		y: 0
	};
	...
	var rawFile = Assets.getText('mods/characters.json');
		data = Json.parse(rawFile);
		moreData = data.data; 

		for (i in 0...moreData.length)
		{
			char.spriteSheet = moreData[i].sprite;
			char.charName = moreData[i].character;
			char.iconColor = moreData[i].iconColor; 
			char.iconName = moreData[i].icon;
			char.animationsName[i] = moreData[i].animations;
			char.x = moreData[i].x;
			char.y = moreData[i].y;
		}*/
